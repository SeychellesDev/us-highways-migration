<?php include "../../../static/top.php"; ?>
            ...
            <?php include "../../../static/table.php"; ?>
                <tr>
                    ...
                    <td class="content text-dark"><a href="../us-highways/1.php">US-1 - S Dixie Hwy (SB) / Federal Hwy (NB)</a>, Miami, Florida 33129</td>
                    <td class="content text-dark">I-95, Miami, Florida 33135</td>
                    <td class="content text-dark">Start of Route<br>Start I-95 in Florida<br>Start Miami-Dade County</td>
                </tr>