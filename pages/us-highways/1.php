<?php include "../../static/top.php"; ?>
            ...
            <section id="scus1">
                ...
                <tr>
					...
					<td class="content text-dark small">1385.95 km ( + 2.72 km )</td>
                    <td class="content text-dark"></td>
                    <td class="content text-dark">Main St, Elgin, South Carolina 29045</td>
                    <td class="content text-dark"></td>
                </tr>
                <tr>
                    <td class="content text-dark small">865.22 mi ( + 4.19 mi )</td>
					<td class="content text-dark small">1392.69 km ( + 6.74 km )</td>
                    <td class="content text-dark"></td>
